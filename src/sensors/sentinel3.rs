...
impl Sensor for Sentinel3Sensor {
    ...
    fn wavelength(&self, band: &str) -> Option<f64> {
        let wavelengths = [
            400.0, 412.5, 442.5, 490.0, 510.0, 560.0, 620.0, 665.0, 673.75, 681.25, 708.75, 753.75,
            761.25, 764.375, 767.5, 778.75, 865.0, 885.0, 900.0, 940.0, 1020.0,
        ];
    ...
    fn bandwidth(&self, band: &str) -> Option<f64> {
        let bandwidths = [
            15.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 7.5, 7.5, 10.0, 7.5, 2.5, 3.75, 2.5,
            15.0, 20.0, 10.0, 10.0, 20.0, 40.0,
        ];
