...
use crate::{core::Metadata, AcoliteError, Result};
...
pub fn parse_s2_metadata(path: &str) -> Result<Metadata> {
    ...
    let sensor = extract_tag(&content, "SPACECRAFT_NAME").unwrap_or_else(|| "S2A_MSI".to_string());
...
mod tests {
    ...
    fn test_extract_tag() {
        ...
        assert_eq!(
            extract_tag(xml, "SPACECRAFT_NAME"),
