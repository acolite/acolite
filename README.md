...
## Dependencies
ACOLITE is coded in Python 3, and requires the following Python packages to run with all functionality:`numpy matplotlib scipy gdal pyproj astropy cartopy scikit-image pyhdf pyresample netcdf4 h5py`
