...
Currently only the generic LUTs are provided in this repository, these will be resampled to a specific sensor the first time they are needed. This resampling will take a few minutes (or much longer -- hours -- in the case of the "reverse LUTs"), but saves several GB on the initial download volume. Users can download already resampled LUTs from a separate repository: https://github.com/acolite/acolite_luts
