                    ...
                    if btags[b] in meta['BAND_INFO']:
                        ...
                        if update_projection:
                            try:
                                ...
                                print("Could not determine projection from {} error {}, {}, {}".format(ifile_, err, ifile_, type(err)))
                                pass
                    else:
                        ...
                        try:
                            ...
                            print("Could not determine projection from {} error {}, {}, {}".format(pifile, err, pifile, type(err)))
                            pass
