## def l2_convert
## converts landsat L2 bundle data to l2a NetCDF
...
def l2_convert(inputfile, output = None, settings = None,
    ...
    for bundle in inputfile:
        ...
        if level[0:2].upper() != 'L2':
            print('Only Level 2 Landsat data can be converted by l2_convert. {} is {}'.format(bundle, level))
            continue
